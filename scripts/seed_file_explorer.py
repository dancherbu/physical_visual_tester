...
KNOWLEDGE_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "file_explorer_knowledge.json"))
...
def main():
    print("📂 Starting File Explorer Knowledge Seeding...")
    ...
    for scenario in knowledge_base:
        ...
        for item in actions:
            ...
            if goal and action:
                ...
                print(f"   🔹 Embedding File Action: '{goal}'...", end='')
                ...
                if vector:
                    payload = {
                        ...
                        "source": "file_explorer_knowledge" 
                    }
    ...
    print(f"\n🎉 File Explorer Seeding Complete! Added {total_added} skills to Memory.")
